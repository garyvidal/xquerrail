...
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  ...
  <div class="entry-meta">
    <div class="date ui-state-highlight ui-corner-left"> <span class="day">
      <?php the_time('d') ?>
      </span> <span>
      <?php the_time('M') ?>
      </span> </div>
...
<?php else : ?>
<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  <div class="entry-title-wrapper ui-corner-right">
    <h2 class="entry-title"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'twentyten' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">
      <?php the_title(); ?>
      </a></h2>
    <div class="entry-meta">
  ...
  <!-- .entry-content -->
  <?php endif; ?>
  <div class="entry-utility ui-state-default ui-corner-all">
