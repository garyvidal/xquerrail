...
<ul id="navigation" style="font-size:.8em;">
    <li>
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    <li><a href="validate">Form validation</a></li>
                    <li><a href="table_modal"><b>Add to table modal</b></a></li>
            ...
            <li>
                ...
                <ul>
                    <li><a href="tables">Sortable Tables</a></li>
            ...
            <li><a href="msg">Response Messages</a></li>
            <li><a href="icons">Icons</a></li>
            <li><a href="icons">Buttons and Elements</a></li>
            <li><a href="logout">Logout (Login Page)</a></li>
    ...
    <li>
        ...
        <ul>
            <li>
                <a href="three-columns-layout">Three columns</a>
            </li>
            <li>
                <a href="two-column-layout">Two columns</a>
            </li>
            <li>
                <a href="no-rounded">No rounded corners</a>
            </li>
            <li>
                <a href="content_boxes">Available content boxes</a>
            </li>
        </ul>
    </li>
    <li>
        ...
        <ul>
            <li>
                <a href="page-left-sidebar">Page with left sidebar</a>
            </li>
            <li>
                <a href="page_dynamic_sidebar">Page with dynamic sidebar</a>
            </li>
            <li>
