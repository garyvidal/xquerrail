      ...
      (<h4>Main Modules</h4>,
        ...
        return
         ( display:build-link("get-module",
                               $local, 
                               (fn:base-uri($x)),
                                display:decode-uri(xs:string($x/xq:module/xq:uri[0]))),
           <br/> )
      )
    else
      ()
...
{
   (<h4>Module URI</h4>,
    <h1>{ display:decode-uri(xs:string((fn:doc($uri)/xq:xqdoc/xq:module/xq:uri)[1])) }</h1>,
...
{
  xs:string(($e/ancestor::xq:xqdoc/xq:module/xq:uri)[1])
};
