...
module namespace wijmo = "http://www.xquerrail-framework.com/library/wijmo";

import module namespace js = "http://www.xquerrail-framework.com/helper/javascript"
at "/_framework/helper/javascript.xqy";
...
{(
    <video controls="controls" id="video-template" width="720" height="486">
